...
typedef enum {
    ...
    DIFF_ERROR, COMP_ERROR, PO_ERROR, PF_ERROR, ACCOLO_ERROR, ACCOLF_ERROR, CROCHO_ERROR, CROCHF_ERROR, FIN_ERROR, BOOL_ERROR, ERREUR_ERROR, NUM_ERROR, 
    NUM_TYPE_ERROR, STRING_TYPE_ERROR, UNIT_ERROR, GUILL_ERROR, ID_ERROR, END_ERROR,
    // complex errors :
