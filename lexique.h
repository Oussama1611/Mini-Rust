...
typedef enum {
    ...
    MULT_TOKEN, DIV_TOKEN, REST_TOKEN, OR_TOKEN, AND_TOKEN, VIR_TOKEN, AFF_TOKEN, INF_TOKEN, INFEG_TOKEN, SUP_TOKEN, SUPEG_TOKEN, 
    DIFF_TOKEN, COMP_TOKEN, PO_TOKEN, PF_TOKEN, ACCOLO_TOKEN, ACCOLF_TOKEN, CROCHO_TOKEN,IN_TOKEN, CROCHF_TOKEN, FIN_TOKEN, BOOL_TOKEN, ERREUR_TOKEN, NUM_TOKEN, NUM_TYPE_TOKEN, UNIT_TOKEN, ID_TOKEN, 
    END_TOKEN
} CODES_LEX;
